    ...
    <Link to={linkUrl} className="block w-full group">
      <div className="relative rounded-lg overflow-hidden transform transition-all duration-300 ease-in-out hover:scale-[1.02]">
        <img
          ...
          loading="lazy"
        />
        <div className="absolute top-2 left-2 bg-black/60 group-hover:bg-[#393E46] group-hover:backdrop-blur-2xl backdrop-blur-sm rounded-full p-2 transition-all duration-300 ease-in-out hover:scale-105">
